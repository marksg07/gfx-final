...
public:
    ...
    static FloatBinding* bindTextbox(
         QLineEdit *textbox, float &value, float minValue, float maxValue);
    static FloatBinding* bindDial(
         QDial *dial, float &value, float minValue, float maxValue, bool wrappingExtendsRange);
    //static FloatBinding* bindTextbox(QLineEdit *textbox, float &value, float minValue, float maxValue);
